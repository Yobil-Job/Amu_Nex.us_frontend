...
const DeleteStudentDialog = ({ student, isOpen, onClose, onSuccess }: DeleteStudentDialogProps) => {
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-xs text-muted-foreground">
                  Deleting <span className="font-semibold text-white">{studentName}</span> will:
                </p>
                <ul className="list-disc list-inside text-xs text-muted-foreground mt-2 space-y-1">
                  <li>Remove all student data</li>
                  <li>Remove club memberships</li>
                  <li>Remove event participations</li>
